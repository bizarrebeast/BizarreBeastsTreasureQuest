import{M as p,a7 as I,R as l,j as le,c as k,r as B,i as g,x as c,n as R,e as ce,b as h,u as U,a5 as de,t as L,a as F,O as E,q as K,A as V,h as ue,S,a8 as O,T as pe,a9 as he,P as me,C as fe,k as we}from"./Web3Utils-BRIOHfTF.js";import{c as w,n as u,r as d,U as ee}from"./index-BrjUboAN.js";import{o as T}from"./if-defined-BrgvXt0H.js";import"./index-B-WrvfhI.js";import"./index-Vl1dJ8BS.js";import{H as G}from"./HelpersUtil-Bjvz0AaL.js";import"./index-DciViAC8.js";import"./index-DnECKsWL.js";import"./index-D0nPICWt.js";import"./index-De8qk1EU.js";import{S as be}from"./SwapController-C5whyYvZ.js";import"./main-D5HJ1j_d.js";import"./index-CYwEQoX3.js";import"./index-DZi6pn7R.js";import"./ConstantsUtil-Dmg8YACJ.js";const te={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){p.shake();return}if(await I.isSIWXCloseDisabled()){p.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&le.disconnect(),p.close()}},ge=k`
  :host {
    display: block;
...
`;var X=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};const xe={info:"info",success:"checkmark",warning:"warningCircle",error:"warning"};let P=class extends g{constructor(){super(...arguments),this.message="",this.type="info"}render(){return c`
    ...
    `}onClose(){R.close()}};P.styles=[B,ve];X([u()],P.prototype,"message",void 0);X([u()],P.prototype,"type",void 0);P=X([w("wui-alertbar")],P);const ke=k`
  :host {
    display: block;
    position: absolute;
    top: ${({spacing:e})=>e[3]};
...
`;var v=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};let m=class extends g{constructor(){super(...arguments),this.resizeObserver=void 0,this.transitionDuration="0.15s",this.transitionFunction="",this.history="",this.view="",this.setView=void 0,this.viewDirection="",this.historyState="",this.previousHeight="0px"}updated(t){if(t.has("history")){const o=this.history;this.historyState!==""&&this.historyState!==o&&this.onViewChange(o)}t.has("transitionDuration")&&this.style.setProperty("--local-duration",this.transitionDuration),t.has("transitionFunction")&&this.style.setProperty("--local-transition",this.transitionFunction)}firstUpdated(){this.transitionFunction&&this.style.setProperty("--local-transition",this.transitionFunction),this.style.setProperty("--local-duration",this.transitionDuration),this.historyState=this.history,this.resizeObserver=new ResizeObserver(t=>{for(const o of t)if(o.target===this.getWrapper()){let r=o.contentRect.height;const a=parseFloat(getComputedStyle(document.documentElement).getPropertyValue("--apkt-footer-height")||"0");r=r+a,this.style.setProperty("--local-border-bottom-radius",a?"var(--apkt-borderRadius-5)":"0px"),this.style.setProperty("--local-container-height",`${r}px`),this.previousHeight!=="0px"&&this.style.setProperty("--local-duration-height",this.transitionDuration),this.previousHeight=`${r}px`}}),this.resizeObserver.observe(this.getWrapper())}disconnectedCallback(){const t=this.getWrapper();t&&this.resizeObserver&&this.resizeObserver.unobserve(t)}render(){return c`
    ...
    `}onViewChange(t){const o=t.split(",").filter(Boolean),r=this.historyState.split(",").filter(Boolean),a=r.length,i=o.length,n=o[o.length-1]||"",s=ee.cssDurationToNumber(this.transitionDuration);let b="";i>a?b="next":i<a?b="prev":i===a&&o[i-1]!==r[a-1]&&(b="next"),this.viewDirection=`${b}-${n}`,setTimeout(()=>{this.historyState=t,this.setView?.(n)},s),setTimeout(()=>{this.viewDirection=""},s*2)}getWrapper(){return this.shadowRoot?.querySelector("div.page")}};m.styles=[Ie];v([u({type:String})],m.prototype,"transitionDuration",void 0);v([u({type:String})],m.prototype,"transitionFunction",void 0);v([u({type:String})],m.prototype,"history",void 0);v([u({type:String})],m.prototype,"view",void 0);v([u({attribute:!1})],m.prototype,"setView",void 0);v([d()],m.prototype,"viewDirection",void 0);v([d()],m.prototype,"historyState",void 0);v([d()],m.prototype,"previousHeight",void 0);m=v([w("w3m-router-container")],m);export{Q as AppKitModal,J as W3mModal,y as W3mModalBase,m as W3mRouterContainer};
