import{c as f,i as m,C as N,b as g,j as H,a6 as l,x as u,r as W,e as V,R as v,N as L,u as M,S as _,k as q,a as Y,l as K,W as G}from"./Web3Utils-BRIOHfTF.js";import{n as d,r as c,c as w,U as $}from"./index-BrjUboAN.js";import"./index-ChFfvf8e.js";import"./index-DnECKsWL.js";import{e as O,n as D}from"./ref-BDJihUvJ.js";import{n as J,s as Q}from"./ConstantsUtil-Dmg8YACJ.js";import"./index-DZi6pn7R.js";import"./index-DKCQkHM9.js";import{S as F}from"./SwapController-C5whyYvZ.js";import"./index-C7qXAUPc.js";import"./index-B4VlrwD6.js";import"./index-BENe6gZJ.js";import"./index-Vl1dJ8BS.js";import"./index-C9FjAwcR.js";import{o as X}from"./if-defined-BrgvXt0H.js";import"./main-D5HJ1j_d.js";import"./index-DciViAC8.js";import"./index-B6sUXBO_.js";const Z=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var E=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let A=class extends m{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){return this.inputElementRef?.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
    ...
    /> `}dispatchInputChangeEvent(t){const n=t.data;if(n&&this.inputElementRef?.value)if(n===","){const r=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=r,this.value=`${this.value}${r}`}else J.test(n)||(this.inputElementRef.value.value=this.value.replace(new RegExp(n.replace(Q,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:this.inputElementRef.value?.value,bubbles:!0,composed:!0}))}};A.styles=[W,V,ee];E([d({type:Boolean})],A.prototype,"disabled",void 0);E([d({type:String})],A.prototype,"value",void 0);E([d({type:String})],A.prototype,"placeholder",void 0);A=E([w("wui-input-amount")],A);const te=f`
  :host {
    width: 100%;
    height: 100px;
    border-radius: ${({borderRadius:e})=>e[5]};
...
`;var b=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let p=class extends m{constructor(){super(),this.unsubscribe=[],this.token=l.state.token,this.sendTokenAmount=l.state.sendTokenAmount,this.receiverAddress=l.state.receiverAddress,this.receiverProfileName=l.state.receiverProfileName,this.loading=l.state.loading,this.message="Preview Send",this.token&&(this.fetchBalances(),this.fetchNetworkPrice()),this.unsubscribe.push(l.subscribe(t=>{this.token=t.token,this.sendTokenAmount=t.sendTokenAmount,this.receiverAddress=t.receiverAddress,this.receiverProfileName=t.receiverProfileName,this.loading=t.loading}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return this.getMessage(),u` <wui-flex flexDirection="column" .padding=${["0","4","4","4"]}>
    ...
    </wui-flex>`}async fetchBalances(){await l.fetchTokenBalance(),l.fetchNetworkBalance()}async fetchNetworkPrice(){await F.getNetworkTokenPrice()}onButtonClick(){v.push("WalletSendPreview")}getMessage(){this.message="Preview Send",this.receiverAddress&&!N.isAddress(this.receiverAddress,g.state.activeChain)&&(this.message="Invalid Address"),this.receiverAddress||(this.message="Add Address"),this.sendTokenAmount&&this.token&&this.sendTokenAmount>Number(this.token.quantity.numeric)&&(this.message="Insufficient Funds"),this.sendTokenAmount||(this.message="Add Amount"),this.sendTokenAmount&&this.token?.price&&(this.sendTokenAmount*this.token.price||(this.message="Incorrect Value")),this.token||(this.message="Select Token")}};p.styles=ie;b([c()],p.prototype,"token",void 0);b([c()],p.prototype,"sendTokenAmount",void 0);b([c()],p.prototype,"receiverAddress",void 0);b([c()],p.prototype,"receiverProfileName",void 0);b([c()],p.prototype,"loading",void 0);b([c()],p.prototype,"message",void 0);p=b([w("w3m-wallet-send-view")],p);const ne=f`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
`;var S=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let k=class extends m{constructor(){super(),this.unsubscribe=[],this.tokenBalances=l.state.tokenBalances,this.search="",this.onDebouncedSearch=N.debounce(t=>{this.search=t}),this.fetchBalancesAndNetworkPrice(),this.unsubscribe.push(l.subscribe(t=>{this.tokenBalances=t.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return u`
    ...
    `}templateTokens(){return this.tokens=this.tokenBalances?.filter(t=>t.chainId===g.state.activeCaipNetwork?.caipNetworkId),this.search?this.filteredTokens=this.tokenBalances?.filter(t=>t.name.toLowerCase().includes(this.search.toLowerCase())):this.filteredTokens=this.tokens,u`
      <wui-flex
    ...
    `}onBuyClick(){v.push("OnRampProviders")}onInputChange(t){this.onDebouncedSearch(t.detail)}handleTokenClick(t){l.setToken(t),l.setTokenAmount(void 0),v.goBack()}};k.styles=ne;S([c()],k.prototype,"tokenBalances",void 0);S([c()],k.prototype,"tokens",void 0);S([c()],k.prototype,"filteredTokens",void 0);S([c()],k.prototype,"search",void 0);k=S([w("w3m-wallet-send-select-token-view")],k);const re=f`
  :host {
    height: 32px;
    display: flex;
    align-items: center;
...
`;var x=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let h=class extends m{constructor(){super(),this.unsubscribe=[],this.token=l.state.token,this.sendTokenAmount=l.state.sendTokenAmount,this.receiverAddress=l.state.receiverAddress,this.receiverProfileName=l.state.receiverProfileName,this.receiverProfileImageUrl=l.state.receiverProfileImageUrl,this.caipNetwork=g.state.activeCaipNetwork,this.loading=l.state.loading,this.unsubscribe.push(l.subscribe(t=>{this.token=t.token,this.sendTokenAmount=t.sendTokenAmount,this.receiverAddress=t.receiverAddress,this.receiverProfileName=t.receiverProfileName,this.receiverProfileImageUrl=t.receiverProfileImageUrl,this.loading=t.loading}),g.subscribeKey("activeCaipNetwork",t=>this.caipNetwork=t))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return u` <wui-flex flexDirection="column" .padding=${["0","4","4","4"]}>
    ...
    >`}sendValueTemplate(){if(this.token&&this.sendTokenAmount){const n=this.token.price*this.sendTokenAmount;return u`<wui-text variant="md-regular" color="primary"
      ...
      >`}return null}async onSendClick(){if(!this.sendTokenAmount||!this.receiverAddress){_.showError("Please enter a valid amount and receiver address");return}try{await l.sendToken(),_.showSuccess("Transaction started"),v.replace("Account")}catch(t){let n="Failed to send transaction. Please try again.";g.state.activeChain===q.CHAIN.SOLANA&&t instanceof Error&&(n=t.message),_.showError(n),console.error("SendController:sendToken - failed to send transaction",t);const r=t instanceof Error?t.message:"Unknown error";Y.sendEvent({type:"track",event:"SEND_ERROR",properties:{message:r,isSmartAccount:K(g.state.activeChain)===G.ACCOUNT_TYPES.SMART_ACCOUNT,token:this.token?.symbol||"",amount:this.sendTokenAmount,network:g.state.activeCaipNetwork?.caipNetworkId||""}})}}onCancelClick(){v.goBack()}};h.styles=ae;x([c()],h.prototype,"token",void 0);x([c()],h.prototype,"sendTokenAmount",void 0);x([c()],h.prototype,"receiverAddress",void 0);x([c()],h.prototype,"receiverProfileName",void 0);x([c()],h.prototype,"receiverProfileImageUrl",void 0);x([c()],h.prototype,"caipNetwork",void 0);x([c()],h.prototype,"loading",void 0);h=x([w("w3m-wallet-send-preview-view")],h);export{k as W3mSendSelectTokenView,h as W3mWalletSendPreviewView,p as W3mWalletSendView};
